...
class NotionAttachmentUploadTests(unittest.TestCase):
    def test_upload_attachments_success(self):
        ...
        att = InputAttachment(name="greet.txt", content_type="text/plain", source="inline_data", data=data_b64)
        ...
        self.assertEqual(client.descriptors[0][0], "greet.txt")
    ...
    def test_task_failure_raises(self):
        ...
        data_b64 = base64.b64encode(b"fail me").decode()
        att = InputAttachment(name="bad.bin", content_type="application/octet-stream", source="inline_data", data=data_b64)
